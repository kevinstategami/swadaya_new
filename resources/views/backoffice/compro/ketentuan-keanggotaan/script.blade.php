<script>
  var table = $("#table-ketentuanKeanggotaan").DataTable({
    "processing": true,
    "ordering": false,
    "serverSide": true,
    "ajax": {
    ...
    columns: [
        ...
        {data: 'description'},
        {
          ...
          {
            var url = '{{url('backoffice/konfigurasi/ketentuan-keanggotaan/edit')}}/';
  ...
  function deleteRecord(id){
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
              url: "{!! url('backoffice/konfigurasi/ketentuan-keanggotaan/delete') !!}/" + id,
              dataType: "json",
              type: "get",
