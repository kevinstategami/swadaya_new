  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="cmsIntroductionModalLabel">Form Pengenalan Tentang Kami</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="updateCmsIntroduction" class="form-group row" method="POST" action="{{route('updateCmsIntroduction')}}" enctype="multipart/form-data">
          @csrf
          <div class="col-md-12">
            <div class="form-group">
              <label class="form-label">Judul</label>
              <input type="text" class="form-control" name="title_bgau" id="cmsTitleIntroduction1"/>
            </div>
            <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-warning bg-orange text-white" onclick="updateCmsIntroduction()">Simpan</button>
      </div>
    </div>
  </div>
</div>