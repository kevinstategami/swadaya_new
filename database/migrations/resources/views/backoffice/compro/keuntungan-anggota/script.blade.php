<script>
  var table = $("#table-keuntunganAnggota").DataTable({
    "processing": true,
    "ordering": false,
    "serverSide": true,
    "ajax": {
    ...
    columns: [
        ...
        {data: 'description'},
        {
          ...
          {
            var url = '{{url('backoffice/konfigurasi/keuntungan-anggota/edit')}}/';
  ...
  function deleteRecord(id){
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
              url: "{!! url('backoffice/konfigurasi/keuntungan-anggota/delete') !!}/" + id,
              dataType: "json",
              type: "get",
