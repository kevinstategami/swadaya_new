<script>
  var table = $("#table-strukturAnggota").DataTable({
      "processing": true,
      "ordering": false,
      "serverSide": true,
      "ajax":{
      ...
      columns: [
        ...
        },
        {
          ...
          "render": function ( data, type, row, meta )
          {
            var url = '{{url('backoffice/konfigurasi/struktur-anggota/edit')}}/';
            return '<div class="text-center">'+
    ...
    function deleteRecord(id){
      Swal.fire({
          ...
          if (result.isConfirmed) {
              $.ajax({
                url: "{!! url('backoffice/konfigurasi/struktur-anggota/delete') !!}/" + id,
                dataType: "json",
                type: "get",
